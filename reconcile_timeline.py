...
NOTES = (
    ...
    "(6) MÉTODO, declarado para não induzir leitura errada: estes nove estados foram MONTADOS À MÃO em "
    ...
    "94/96 mede. Rodar src/ledger.py sobre estes mesmos eventos devolve outra timeline: ela coincide até "
    "2005-08-16 e diverge a partir de 2006-10-20 (2.225 cotas em vez de 2.000), terminando em 202.822 em "
    "2008-06-27 em vez de 368.102 — porque os eventos não carregam a "
